...
function eighttracks_shortcode( $atts, $content) {
			...
			if ( $width == '' ) {
             ...
             return '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" height="' . esc_attr( $height ) . '" width="' .esc_attr( $width ) . '"><param name="movie" value="' . $content . '/player_v3/' . $playops .'"></param><param name="allowscriptaccess" value="always"><param name="allowscriptaccess" value="always"><embed height="' . esc_attr( $height ) . '" src="' . $content . '/player_v3/' . $playops . '" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" allowscriptaccess="always" height="' . esc_attr( $height ) . '" width="' . esc_attr( $width ) . '"></embed></object>';
      }
